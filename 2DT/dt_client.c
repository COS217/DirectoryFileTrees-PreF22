...
int main(void) {
  ...
  assert(DT_insertPath("a/b/c") == SUCCESS);
  assert(DT_containsPath("a") == TRUE);
  assert(DT_containsPath("a/b") == TRUE);
  assert(DT_containsPath("a/b/c") == TRUE);
  assert((temp = DT_toString()) != NULL);
  fprintf(stderr, "%s\n", temp);
  free(temp);
  assert(DT_insertPath("a/b/c") == ALREADY_IN_TREE);
  ...
  fprintf(stderr, "%s\n", temp);
  free(temp);
  assert(DT_insertPath("a/b/d/e/e") == SUCCESS);
  assert(DT_containsPath("a/b/d/e/e") == TRUE);
  assert(DT_containsPath("a/b/d/e/f") == FALSE);
  assert(DT_containsPath("a/b/d/e/e/e") == FALSE);
  assert(DT_containsPath("a/b/d/e/e/f") == FALSE);
  assert((temp = DT_toString()) != NULL);
  fprintf(stderr, "%s\n", temp);
  free(temp);
  ...
  assert(DT_containsPath("a/b/d/e/e") == TRUE);
  assert(DT_containsPath("a/b/d/e/f") == FALSE);
  assert(DT_rmPath("a/b/d/e/f") == NO_SUCH_PATH);
  assert(DT_rmPath("a/b/d/e") == SUCCESS);
  assert(DT_containsPath("a/b/d") == TRUE);
  assert(DT_containsPath("a/b/d/e") == FALSE);
  assert(DT_containsPath("a/b/d/e/e") == FALSE);
  assert((temp = DT_toString()) != NULL);
  fprintf(stderr, "%s\n", temp);
  free(temp);
